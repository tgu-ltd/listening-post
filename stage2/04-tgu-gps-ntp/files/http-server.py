...
class Handler(BaseHTTPRequestHandler):
    ...
    API_POSTS = {
        ...
        'scanner_upload_fat': {"cmd": SCANNER.upload_fat_file},
    }
    API_GETS = {
        'scanner_status': {"cmd": SCANNER.status},
        'scanner_stop': {"cmd": SCANNER.stop_thread},
        'scanner_get_scan_files': {"cmd": SCANNER.get_scan_files},
        'scanner_remove_scan_files': {"cmd": SCANNER.remove_scan_files},
        'scanner_get_live_data': {"cmd": SCANNER.get_live_data},
        'scanner_download_live_file': {"cmd": SCANNER.download_live_file},
        'scanner_restore_default_fat': {"cmd": SCANNER.restore_default_fat},
        'scanner_download_fat': {"cmd": SCANNER.download_fat_file},
